...
const locatorsData = [
...

  {
    ...
    details: {
      name: "Dmart",
      image: "https://www.projectsmonitor.com/wp-content/uploads/2021/09/@DMartOfficiall.jpg",
      shortDescription: "Affordable shopping destination for groceries.",
      fullDescription: "Dmart Connaught Place offers grocery, home supplies, and daily essentials.",
      address: "Connaught Place, Delhi",
      timings: "Mon-Sun: 9 AM - 10 PM",
      payment: "Cash, Credit/Debit Cards, UPI",
      mapLink: "https://maps.example.com/dmart-connaughtplace",
      menuLink: "https://www.dmart.in/",
      rating: "4.2",
      tags: ["Essentials", "Bulk Deals", "Smart Shopping"],
      images: [
        "https://www.projectsmonitor.com/wp-content/uploads/2021/09/@DMartOfficiall.jpg",
        "https://www.goodreturns.in/img/1200x60x675/2020/04/dmart-1525851463-1586576977.jpg"
      ],
      ...
      actionButtons: [
        ...
        },
        {
          text: "Directions",
          icon: "fas fa-directions",
          url: "https://maps.example.com/dmart-connaughtplace",
          type: "secondary"
        }
      ]
    }
  ...
  // Mumbai - Andheri
  {
    ...
    details: {
      name: "Dmart",
      image: "https://www.projectsmonitor.com/wp-content/uploads/2021/09/@DMartOfficiall.jpg",
      shortDescription: "Affordable groceries for every home.",
      fullDescription: "Dmart in Andheri provides groceries, vegetables, and kitchen essentials under one roof.",
      ...
      menuLink: "https://www.dmart.in/",
      rating: "4.4",
      tags: ["Household Needs", "Grocery", "Great Deals"],
      images: [
        "https://www.projectsmonitor.com/wp-content/uploads/2021/09/@DMartOfficiall.jpg",
        "https://www.goodreturns.in/img/1200x60x675/2020/04/dmart-1525851463-1586576977.jpg"
      ],
      ...
      actionButtons: [
        ...
        },
        {
          text: "Directions",
          icon: "fas fa-directions",
          url: "https://maps.example.com/dmart-andheri",
          type: "secondary"
        }
      ]
    }
    ...
    <div class="locators-content">
      <div class="locators-header">
        <div class="header-title-container">
          <h2>Stores</h2>
          <div class="header-subtitle">Find local businesses and services</div>
        </div>
...
/* Combined Location & Hours Info Item */
.info-item {
...
function sortLocators(sortBy) {
  ...
  switch(sortBy) {
    ...
    case 'name':
      ...
      break;
    case 'distance':
      // This would require actual location data to implement properly
      // For now, we'll just sort alphabetically as a placeholder
      sortedData.sort((a, b) => a.details.address.localeCompare(b.details.address));
      break;
  }
  
  const grid = document.getElementById('locatorsGrid');
  grid.innerHTML = renderLocatorCards(sortedData);
}
